...
function M.base()
  ...
  return {
    ...
    Comment       = { fg = M.brighten("${uaihu.color.text_wht}", -0.4, 0) },
    ...
    Normal        = { fg = "${uaihu.color.text_wht}", bg = "${uaihu.color.bg_main}" },
    ...
    Keyword         = { fg = "${uaihu.color.symbols}" },
    ...
    String          = { fg = "${uaihu.color.text_wht}" },
...
function M.set_options()
    ...
    vim.g.terminal_color_0  = "${uaihu.ansi.black}"
    vim.g.terminal_color_8  = "${uaihu.ansi.black}" -- bright
    vim.g.terminal_color_7  = "${uaihu.ansi.white}"
    vim.g.terminal_color_15 = "${uaihu.ansi.white}" -- bright
    vim.g.terminal_color_1  = "${uaihu.ansi.red}"
    vim.g.terminal_color_9  = "${uaihu.ansi.red}" -- bright
    vim.g.terminal_color_2  = "${uaihu.ansi.green}"
    vim.g.terminal_color_10 = "${uaihu.ansi.green}" -- bright
    vim.g.terminal_color_3  = "${uaihu.ansi.yellow}"
    vim.g.terminal_color_11 = "${uaihu.ansi.yellow}" -- bright
    vim.g.terminal_color_4  = "${uaihu.ansi.blue}"
    vim.g.terminal_color_12 = "${uaihu.ansi.blue}" -- bright
    vim.g.terminal_color_5  = "${uaihu.ansi.magenta}"
    vim.g.terminal_color_13 = "${uaihu.ansi.magenta}" -- bright
    vim.g.terminal_color_6  = "${uaihu.ansi.cyan}"
    vim.g.terminal_color_14 = "${uaihu.ansi.cyan}" -- bright
