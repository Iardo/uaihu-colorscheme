...
-- Plugins
--------------------
style.bracketmatch_color = { common.color "${uaihu.color.separator}" }                  -- bracketmatch
style.guide = { common.color "${uaihu.color.text_wht}${uaihu.alpha.low}" }
style.guide_highlight = { common.color "${uaihu.color.text_wht}${uaihu.alpha.medium}" } -- indentguide
style.guide_width = 1                                                                   -- indentguide
style.linter_warning = { common.color "${uaihu.color.diff_negative}" }                  -- linter
        `
    }
}
